...
const Products = () => {
  ...
  const clearFilters = () => {
    ...
    setsegment(false);
    setsuitable(false);
    setrawmaterials(false);
    setpattern(false);
    setCategory(""); // Clear the selected category filter
    setRotate("rotate90deg");
    setIcocls("rotate90deg");
    setworkcls("rotate90deg");
    setfabriccls("rotate90deg");
    setsegmentcls("rotate90deg");
    setsuitablecls("rotate90deg");
    setrawcls("rotate90deg");
    setpatterncls("rotate90deg");
  };
